...
//     char s21_buff[BUFF_SIZE], std_buff[BUFF_SIZE]; unsigned int value =
//     555777; s21_sprintf(s21_buff,"ab %u cd", value); sprintf(std_buff,"ab %u
//     cd", value); ck_assert_str_eq(s21_buff, std_buff);
// } END_TEST
