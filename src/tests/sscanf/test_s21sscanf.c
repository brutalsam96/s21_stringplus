...
START_TEST(test_sscanf_g_multiple_values) {
  ...
  sscanf(input, "%g %g %g", (float *)&std_val1, (float *)&std_val2,
         (float *)&std_val3);
...
START_TEST(test_sscanf_s_large_string) {
  char input[] =
      "This is a very long string with spaces that should be truncated by "
      "sscanf";
  char s21_value[50], std_value[50];
...
START_TEST(test_sscanf_n_with_multiple_formats) {
  ...
  s21_sscanf(input, "%d Hello %d World!%n", &s21_value1, &s21_value2,
             &s21_value2);
...
START_TEST(test_sscanf_n_after_string_literal) {
  ...
  s21_sscanf(input, "Testing %d, %d, %d%n", &s21_value, &s21_value, &s21_value,
             &s21_value);
  sscanf(input, "Testing %d, %d, %d%n", &std_value, &std_value, &std_value,
         &std_value);
...
Suite *sprintf_suite(void) {
  ...
  tcase_add_test(
      tc, test_sscanf_length_modifier_negative_long_int_decimal_with_length);
  ...
  tcase_add_test(
      tc, test_sscanf_length_modifier_mixed_long_int_and_unsigned_long_int);
  tcase_add_test(tc, test_sscanf_length_modifier_unsigned_long_int_octal);
  tcase_add_test(tc,
                 test_sscanf_length_modifier_unsigned_long_int_invalid_input);
  tcase_add_test(tc, test_sscanf_length_modifier_long_double_scientific);
  tcase_add_test(tc,
                 test_sscanf_length_modifier_negative_long_double_scientific);
  ...
  tcase_add_test(tc,
                 test_sscanf_length_modifier_negative_long_double_exponential);
  tcase_add_test(tc, test_sscanf_length_modifier_long_double_precision);
  tcase_add_test(tc,
                 test_sscanf_length_modifier_long_double_precision_exponential);
